  ...
  [345, 396],
  {
    7907: (e, t, s) => {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.default = void 0);
      var o = n(s(2195));
      t.default = o.default.extend({ getSkinPrefix: () => "cards_" });
    },
    2078: (e, t) => {
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.default = void 0);
      ...
      t.default = elementorModules.frontend.handlers.Base.extend({
        ...
        fitImage(e) {
          var t = this.getSettings(),
            ...
            n = s.find("img")[0];
          if (n) {
            var o = s.outerHeight() / s.outerWidth(),
              i = n.naturalHeight / n.naturalWidth;
            s.toggleClass(t.classes.fitHeight, i < o);
          }
        },
        fitImages() {
          var e = jQuery,
            ...
            n = this.getSettings();
          t.isMasonryEnabled()
            ? this.elements.$postsContainer.removeClass(n.classes.hasItemRatio)
            : (this.elements.$postsContainer.toggleClass(
              ...
              this.elements.$posts.each(function () {
                var s = e(this),
                  o = s.find(n.selectors.postThumbnailImage);
                t.fitImage(s),
                  o.on("load", function () {
                    t.fitImage(s);
                  });
        ...
        setColsCountSettings() {
          const e = this.getElementSettings(),
            ...
            s = elementorProFrontend.utils.controls.getResponsiveControlValue(
              e,
              `${t}columns`
            );
    ...
    439: (e, t, s) => {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.default = void 0);
      var o = n(s(2078));
      class ArchivePostsLoadMore extends o.default {}
    ...
    2718: (e, t, s) => {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.default = void 0);
      var o = n(s(7907));
      t.default = o.default.extend({ getSkinPrefix: () => "archive_cards_" });
    },
    6629: (e, t, s) => {
      var n = s(6784);
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.default = void 0);
      var o = n(s(2195));
      t.default = o.default.extend({ getSkinPrefix: () => "archive_classic_" });
    },
  },
]);
