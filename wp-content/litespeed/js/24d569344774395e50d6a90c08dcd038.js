!(function (e) {
  ...
  107: function (e, t, n) {
    ...
    (window.isEditMode = !1),
      ...
      eael.hooks.addAction("widgets.reinit", "ea", function (e) {
        ...
        t.length && t.isotope("layout"),
          ...
          a.length && eael.hooks.doAction("eventCalendar.reinit"),
          s.length && eael.hooks.doAction("testimonialSlider.reinit"),
          l.length && eael.hooks.doAction("teamMemberCarousel.reinit"),
          c.length && eael.hooks.doAction("postCarousel.reinit"),
          u.length && eael.hooks.doAction("logoCarousel.reinit"),
          d.length && eael.hooks.doAction("twitterCarousel.reinit");
      });
    var w,
      b = function (e) {
        void 0 === window.eaelPreventResizeOnClick &&
    ...
    eael.hooks.addAction("ea-advanced-tabs-triggered", "ea", b),
      eael.hooks.addAction("ea-advanced-accordion-triggered", "ea", b),
      jQuery(window).on("elementor/frontend/init", function () {
        (window.isEditMode = elementorFrontend.isEditMode()),
          (window.eael.isEditMode = elementorFrontend.isEditMode()),
          eael.hooks.doAction("init"),
          eael.isEditMode && eael.hooks.doAction("editMode.init");
      }),
      (function (e) {
        (eael.getToken = function () {
          localize.nonce &&
            ...
            e.ajax({
              ...
              success: function (e) {
                e.success &&
                  ((localize.nonce = e.data.nonce), (eael.noncegenerated = !0));
              },
            });
        }),
        ...
        window.addEventListener("hashchange", function () {
          if (t) {
            ...
            "undefined" !== (n = "safari" === n ? "eael-safari" : n) &&
              n &&
          ...
          e(document).on("click", ".eael-onpage-edit-template", function () {
            ...
            "edit" === o
              ? (parent.window.$e.internal("panel/state-loading"),
                parent.window.$e
                  .run("editor/documents/switch", { id: parseInt(n) })
                  .then(function () {
                    t.data("mode", "save"),
                      t.find("span").text("Save & Back"),
                      t
                        .find("i")
                        .addClass("eicon-arrow-left")
                        .removeClass("eicon-edit"),
                      t
                        .closest(".eael-onpage-edit-template-wrapper")
                        .addClass("eael-onpage-edit-activate")
                        .parent()
                        .addClass("eael-widget-otea-active"),
